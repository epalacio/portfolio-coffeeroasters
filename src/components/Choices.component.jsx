    ...
    return ( 
        <div className="w-full px-4 pt-16">
                <div className="w-full p-2 mx-auto">
                    ...
                    {({ open }) => (
                        <>
                        <Disclosure.Button className="flex mt-12 justify-between w-full px-4 py-2 text-collectionTitle font-bold text-left text-gray">
                        ...
                        <Disclosure.Panel className="px-4 pt-4 pb-2 flex flex-row">
                            <div className='rounded-md bg-isabelline hover:bg-paleOrange cursor-pointer px-12 pb-28 pt-8 mx-2'>
                ...
                <a  className='block mx-auto md:mr-0 py-4 px-6 text-white bg-darkCyan hover:bg-viking max-w-max rounded-md font-fraunces font-bold' href="/">Create your plan</a>
            </div>
     );
}
