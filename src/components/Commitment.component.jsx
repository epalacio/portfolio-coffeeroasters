import aboutCommitment from '../img/aboutCommitment.jpg'
...
const Commitment = () => {
    return ( 
        <div className='flex flex-col lg:flex-row items-center p-12'>
            <img className='rounded-md h-auto md:h-commitmentImg' src={aboutCommitment} alt="Man pouring coffee on cup" />
            <div className='px-2 md:px-12 py-10 text-darkGrayBlue text-center md:text-left'>
                <h2 className='font-fraunces text-featuresTitleTablet lg:text-featuresTitleDesktop pb-8'>Our commitment</h2>
